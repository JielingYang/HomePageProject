...
enginePartFrontMenuItemsPositions[INDEX.ENGINE_FRONT_FACE_SVG_1] = {
    left: "70%",
    top: "32.5%"
};
enginePartFrontMenuItemsPositions[INDEX.ENGINE_FRONT_FACE_SVG_2] = {
    left: "90%",
    top: "50%"
};
enginePartFrontMenuItemsPositions[INDEX.ENGINE_FRONT_FACE_SVG_3] = {
    left: "105%",
    top: "67.5%"
};
enginePartFrontMenuItemsPositions[INDEX.ENGINE_FRONT_FACE_SVG_4] = {
    left: "105%",
    top: "85%"
};
...
enginePartMiddleMenuItemsPositions[INDEX.ENGINE_MIDDLE_FACE_SVG_1] = {
    left: "32.5%",
    top: "47.5%"
};
enginePartMiddleMenuItemsPositions[INDEX.ENGINE_MIDDLE_FACE_SVG_2] = {
    left: "67.5%",
    top: "47.5%"
};
enginePartMiddleMenuItemsPositions[INDEX.ENGINE_MIDDLE_FACE_SVG_3] = {
    left: "97.5%",
    top: "70%"
};
enginePartMiddleMenuItemsPositions[INDEX.ENGINE_MIDDLE_FACE_SVG_4] = {
    left: "67.5%",
    top: "95%"
};
enginePartMiddleMenuItemsPositions[INDEX.ENGINE_MIDDLE_FACE_SVG_5] = {
    left: "32.5%",
    top: "95%"
};
...
enginePartBackMenuItemsPositions[INDEX.ENGINE_BACK_FACE_SVG_1] = {
    left: "40%",
    top: "50%"
};
enginePartBackMenuItemsPositions[INDEX.ENGINE_BACK_FACE_SVG_2] = {
    left: "68%",
    top: "70%"
};
enginePartBackMenuItemsPositions[INDEX.ENGINE_BACK_FACE_SVG_3] = {
    left: "40%",
    top: "87.5%"
};
